...
# Start VcXsrv + SO-ARM101 trajectory visualization (project 2) on display :1.
# Equivalent of start_so101_display_vcxsrv.ps1 but launches
# trajectory_viz.launch.py (trajectory recorder + RViz with trajectory view).
...
$displayScript = '/mnt/f/robot_arm_atlas/ros2/run_so101_trajectory_vcxsrv.sh'
...
Write-Host "VcXsrv is ready on $windowsHost`:1; starting trajectory visualization." -ForegroundColor Green
