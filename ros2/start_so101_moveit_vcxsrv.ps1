...
$moveItScript = '/mnt/f/robot_arm_atlas/ros2/run_so101_moveit_vcxsrv.sh'
...
Write-Host "VcXsrv is ready on $windowsHost`:1; starting SO-ARM101 MoveIt/RViz..." -ForegroundColor Green
Write-Host 'Press Ctrl+C in this terminal to stop MoveIt.' -ForegroundColor Yellow
& wsl.exe -d Ubuntu-22.04 -- bash $moveItScript
